      ...
      >
        <div style={{ padding: '20px 22px 8px', textAlign: 'center' }}>
          ...
          <p style={{ margin: 0, fontSize: 13, color: 'var(--text-3)', lineHeight: 1.45 }}>
            Enter the master password to delete “{contact?.name}”. It can be restored from Recycle Bin.
          </p>
        </div>
    ...
    >
      ...
      >
          ...
          {isOrg ? (
            <>
              <div>
                ...
                <input
                  className="directory-focus-field"
                  style={INPUT}
                  value={form.name}
              ...
              <div>
                ...
                <input
                  ...
                  autoComplete="off"
                />
                <datalist id="directory-org-types">
                  {ORG_TYPES.map(t => (
        ...
        <div style={{
          ...
          <button type="button" onClick={onClose} tabIndex={10} className="directory-focus-field"
          ...
          <button type="submit" disabled={saving} tabIndex={11} className="directory-focus-field directory-save-btn"
            style={{
                ...
                {filtered.map((c, i) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        display: 'grid',
                        gridTemplateColumns: 'minmax(0, 1.2fr) minmax(120px, 1fr) minmax(150px, auto) auto',
                        gap: 12,
                        padding: '12px 14px',
                    ...
                    >
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                            ...
                            {catLabel && (
                              <span style={{
                                ...
                                background: '#ccfbf1', color: '#0f766e', lineHeight: 1.3,
                              }}>{catLabel}</span>
                            )}
                          </div>

                          {/* Line 2: role / type / contact */}
                          <div style={{
                            marginTop: 3, display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '2px 10px',
                          }}>
                            {isOrg ? (
                              <>
                                {c.organization && (
                                  <span style={{
                                    ...
                                    background: '#e0f2fe', color: '#0369a1', lineHeight: 1.35,
                                  }}>
                                    {c.organization}
                                  </span>
                                )}
                                {c.title && (
                                  <span style={{
                                    ...
                                    display: 'inline-flex', alignItems: 'center', gap: 4, lineHeight: 1.35,
                                  }}>
                                    <User size={11} /> {c.title}
                                  </span>
                                )}
                              </>
                            ) : (
                              <>
                                {c.title && (
                                  <span style={{ fontSize: 12, color: '#7c3aed', fontWeight: 600, lineHeight: 1.35 }}>
                                    {c.title}
                                  </span>
                                )}
                                {c.organization && (
                          ...
                          {c.email && (
                            <a
                              ...
                              style={{
                                ...
                                fontSize: 12, fontWeight: 600, color: '#b45309', textDecoration: 'none',
                                lineHeight: 1.35,
                              }}
                            >
                      ...
                      {/* Middle: notes */}
                      <div style={{ minWidth: 0, padding: '0 4px', alignSelf: 'center' }}>
                        {c.notes ? (
                          <p style={{
                            margin: 0,
                            fontSize: 14,
                      ...
                      <div style={{
                        ...
                        <button
                          ...
                          style={{
                            ...
                            background: 'transparent', color: '#2563eb', cursor: 'pointer', display: 'grid', placeItems: 'center',
                          }}
                        >
                          <Pencil size={14} />
                        </button>
                        <button
                          ...
                          style={{
                            width: 28, height: 28, padding: 0, border: 'none', borderRadius: 0,
                            background: 'transparent', color: '#b91c1c', cursor: 'pointer', display: 'grid', placeItems: 'center',
                          }}
                        >
                          <Trash2 size={14} />
                        </button>
