...
import {
  ...
  CheckCircle2, Banknote, Landmark, ChevronRight, Pencil, Printer, CreditCard,
} from 'lucide-react'
...
export default function PaymentVoucherPage() {
  ...
  const dirty = !!(creditCoaId || paidTo || lineNarration || lines.some(l => l.account_id || parseFloat(l.amount) > 0))
  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 18 }}>
        ...
        <PageHeader
          icon={CreditCard}
          title={editId ? 'Edit Payment Voucher' : 'Payment Voucher'}
