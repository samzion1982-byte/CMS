...
export const FULL_BACKUP_TABLES = [
  ...
  'cms_backup_settings', 'cms_backup_log', 'cms_recycle_bin',
  ...
  'budgets', 'journal_templates', 'accounting_entities', 'bank_accounts',
...
/** Indian stamp for backup names: 11-08-2026_18:47 (IST, 24-hour) */
...
function backupFilename(kind, date = new Date()) {
  ...
  return kind === 'snapshot' ? `cms-snapshot_${stamp}.json` : `cms-backup_${stamp}.json`
}
